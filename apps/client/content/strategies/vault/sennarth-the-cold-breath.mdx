...
date: 2022-12-12
description: Did you know most female names that start with "Sen" are tribal or Celtic? The only person I've met with a name that started like this was a personal trainer named Seneca who made me flip tires till I threw up. How am I supposed to call this spider a basic white girl name with this material?
---
...
<Mechanic id={372765} name="Breath of Ice" caption="Ice Patches">
  ...
  that deal 19,273 damage per second to players standing in them and causes them to *slide around*.
</Mechanic>
...
<Mechanic id={372082} name="Enveloping Webs" caption="Miasma-Bombing DoT">
  Sennarth inflicts 19,200 physical damage to several players and causes them to drop [Sticky
  Webbing](https://www.wowhead.com/spell=372030) on the ground every second for 6 seconds.
...
They do have an aggro table, but their health is low enough that they are likely to die to random cleave damage. This has the benefit of removing webbing from the platform randomly, but if a player is entomed tanks should be prepared to herd a spider to the player to free them.
...
<Mechanic id={371983} name="Repelling Burst" caption="Knockback">
  ...
  Burst](https://www.wowhead.com/spell=371983) which knocks players back instead. There is more
  danger now as you will also slide backwards because of the ice on the platform, making it easy for
...
<Mechanic id={373048} name="Suffocating Webs" caption="Enveloping Webs v2.0">
  Sennarth cheats and casts [Enveloping Webs](https://www.wowhead.com/spell=372082) but will only drop [Sticky Webbing](https://www.wowhead.com/spell=372030) at the end of the debuff as well as knocking back the player and instantly entombing them. The entomb can be immuned.

This will also target the active tank each time.
...
- Have a plan for [Gossamer Burst](https://www.wowhead.com/spell=373405) at all times. Compared to previous push or pull mechanics in the past, this mechanic shows a web "arrow" on your person for 5 whole seconds to warn you of the impending grip because it is **very fast**. If you are caught unprepared, there is no guarantee you can move your character to a [Sticky Webbing](https://www.wowhead.com/spell=372030) during the grip itself.

  1. Using [Sticky Webbing](https://www.wowhead.com/spell=372030) is the safest option for most classes as it negates the grip and grants the most uptime. While this does apply a stacking movement impairing effect on you, it can be removed by standing in a Spiderling explosion which happens often and does negligable damage. _However_, do not overstay your welcome in the webbing and get yourself entombed.
  2. If your plan is to use a blink, teleport, or movement nullification ability be sure you are consistent. Dying to this mechanic is unacceptable. Trying to big brain play some last-second disengage only to fly horizontally into oblivion is only going to just make for a funny `gif` and get you yelled at.
  3. If your plan is to use a speed-increasing ability it's recommended to be relatively far back in the room. You can also successfully run against the mechanic without a speed increase or webbing by being in the back of the room when the pull happens. I would only recommend this to be done out of necessity and not as someone's usual approach.
...
- As seen in the RaidPlan figure above, when a player is targeted by [Enveloping Webs](https://www.wowhead.com/spell=372082) and are thus being bombarded with [Sticky Webbing](https://www.wowhead.com/spell=372030) it is recommended to place them between the melee and ranged. As in, melee move backwards with the debuff, ranged move foward, room permitting. This will help melee if they haven't gotten the webbing debuff often, or if Spiderlings cleared too many, and is easier for ranged to have webbing in front of them to use instead of having to run to the back of the room to find them if needed.
...
After a while the boss gets tired of the area of the room we are on and will slowly and ominously ascend a ramp to the next stretch of platform. This is still part of phase 1 and she will cast all of the same mechanics during her escalator ride.

[Gossamer Burst](https://www.wowhead.com/spell=373405) is more deadly during this intermission as the [Sticky Webbing](https://www.wowhead.com/spell=372030) is much more scarce. Gold-star players which get [Enveloping Webs](https://www.wowhead.com/spell=372082) can place [Sticky Webbing](https://www.wowhead.com/spell=372030) on the ramp before she starts to ascend.
...
- Sennarth descends to the fourth platform then starts channeling [Apex of Ice](https://www.wowhead.com/spell=372540), covering the entire platform in [Icy Ground](https://www.wowhead.com/spell=372765) permanently making everyone slip and slide until the fight ends. She also takes 99% reduced damage and pulses increasing raid damage until this cast is interrupted.
- The raid becomes progressively more vulnerable to frost damage through [Pervasive Cold](https://www.wowhead.com/spell=372648), acting as her soft-enrage.
- Players should remain spread out to avoid cleaving each other with [Chilling Blast](https://www.wowhead.com/spell=371976) as well as avoiding the landmines these debuffs now spawn [Glacial Plume](https://www.wowhead.com/spell=373559).
- Instead of gripping, the boss now does a knockback called [Repelling Burst](https://www.wowhead.com/spell=371983). Players should avoid getting knocked off the platform, or into [Glacial Plume](https://www.wowhead.com/spell=373559), by using [Sticky Webbing](https://www.wowhead.com/spell=372030) or other utility.
- [Suffocating Webs](https://www.wowhead.com/spell=373048) will entomb those affected, knocking them back, and only dropping a single [Sticky Webbing](https://www.wowhead.com/spell=372030). This will also be cast on the active tank each time, forcing a taunt swap. Players with this mechanic should huddle near melee by the active tank so they are in an ideal position to be freed with Spiderlings.
