...
- **Blazing Fiend** now also casts [Searing Carnage](https://www.wowhead.com/spell=391499), the flame dance mechanic.
...
This intermission will feature fire and lightning elementals with the lightning elemental being kill priority. The raid will start on <Marker type="triangle" /> to bait the [Searing
Carnage](https://www.wowhead.com/spell=374022) dance. When the dance starts everyone ignores their WeakAura and moves as a group into the middle of the room.

Afterward, everyone will remain stacked in melee for baiting dances unless lightning soaks are about to come out in which case the 6 ranged players will disengage from the group to soak them. There are caveats to the dance movements, but in general, your priority is to move together as a group, but if you're separated do not cut off the group.

<Alert type="warning">

While the lightning elemental is alive healers should be in melee range of this or the other elemental as it jumps to healers and we don't want it teleporting out of range. However, the tank should be the only person inside of the lightning elemental's hitbox as it will then pick them for the "get out of the raid" mechanic.
