...
3. [Lightning Breath](https://www.wowhead.com/spell=377594/lightning-breath) is not listed, but WeakAuras can scream at you plenty well enough. They occur after every winds, but there's also a cast between each winds, so the group will need to swivel around her butt. You will be yelled at for dying to this. Her model "arrow" will point in the direction of the arrow if you see them.
