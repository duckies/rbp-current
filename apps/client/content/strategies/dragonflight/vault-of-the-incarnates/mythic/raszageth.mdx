...
<Tabs>
  ...
  <Tab label="1 — Stormsurge">
    ...
    The stormshields aren't that scary for healers either, with things like Resto Druid, Discipline, and Monk ramping covering them easily. However, if you are going to be using a personal during it do so at the end as the damage increases the longer the shield is up.
