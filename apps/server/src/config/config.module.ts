...
export class ConfigModule {
  ...
  private static validate<T extends Dictionary>(schema: Constructor<T>, config: T) {
  ...
  private static getProviders<T extends Dictionary>(schema: Constructor<T>, config: T) {
